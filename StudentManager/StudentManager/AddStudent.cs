        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    sql = "insert into Student(Sname,Sno ,Spassword,Sgrade ,Smajor,Ssex,Sbirth,Shometown,NCampus)values('" + textBoxname.Text.Trim() + "','" + textBoxpname.Text.Trim() + "','" + textBoxpasswd.Text.Trim() + "','" + comboBoxgrade.SelectedItem.ToString() + "','" + comboBoxmajor.SelectedItem.ToString() + "','" + gender + "','" + dateTimePicker1.Value.ToString("yyyy-MM-dd") + "','" + textBoxhometown.Text.Trim() + "','" + textBox1.Text.Trim() + "')";
                    cmd.CommandText = sql;
                    cmd.ExecuteNonQuery();
