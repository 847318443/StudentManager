...
namespace StudentManager
{
    public partial class showkebiaoForm : Form
    {
        ...
        private void showkebiaoForm_Load(object sender, EventArgs e)
        {
            ...
            sql = "select Ctime.CTid as 课程id,Ctime.Cname as 课程名称,Ctime.nteacher as 教师姓名,Ctime.Cterm as 学期,Ctime.Ctime as 上课时间,Ctime.Classroom as 上课地点 from SC,Ctime,Class where Ctime.CTid=SC.Cid and Ctime.Cname=Class.Cname and SC.Sid=" + stuid;
