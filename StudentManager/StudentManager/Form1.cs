        ...
        private void treeView1_AfterSelect(object sender, TreeViewEventArgs e)
        {
            switch (this.treeView1.SelectedNode.Text)
            {
                ...
                case "查询课程":
                    ...
                    break;
                case "添加选课轮次时间":
                    AddSC_Time addsc_time = new AddSC_Time();
                    addsc_time.TopLevel = false;
                    addsc_time.FormBorderStyle = FormBorderStyle.None;
                    addsc_time.WindowState = FormWindowState.Maximized;

                    panel2.Controls.Add(addsc_time);
                    addsc_time.Show();
                    break;
                case "修改选课轮次时间":
                    M_SC_Time m_sc_time = new M_SC_Time();
                    m_sc_time.TopLevel = false;
                    m_sc_time.FormBorderStyle = FormBorderStyle.None;
                    m_sc_time.WindowState = FormWindowState.Maximized;

                    panel2.Controls.Add(m_sc_time);
                    m_sc_time.Show();
                    break;
                case "添加教师信息":
