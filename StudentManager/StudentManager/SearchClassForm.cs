    ...
    public partial class searchclassForm : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else if (comboBoxterm.Text != "" && textBoxclass.Text == "")
            {
                ...
                conn.Open();
                string sql = "select CTid as 课程id,Cname as 课程名,Cterm as 学期,nteacher as 老师 from Ctime where Cterm ='" + comboBoxterm.SelectedItem.ToString() + "'";
            ...
            else if (textBoxclass.Text != "" && comboBoxterm.Text == "")
            {
                ...
                string sql = "select CTid as 课程id,Cname as 课程名,Cterm as 学期,nteacher as 老师 from Ctime  where Cname like '%" + textBoxclass.Text + "%'";
                SqlDataAdapter adp1 = new SqlDataAdapter(sql, conn);
                DataSet ds = new DataSet();
                adp1.Fill(ds);
                //载入基本信息
            ...
            else if (textBoxclass.Text != "" && comboBoxterm.Text != "")
            {
                ...
                conn.Open();
                //textBox1.Text.Trim()  textBox2.Text.Trim()
                string sql = "select CTid as 课程id,Cname as 课程名,Cterm as 学期,nteacher as 老师 from Ctime  where Cname = '" + textBoxclass.Text + "'and Cterm ='" + comboBoxterm.SelectedItem.ToString() + "'";
                SqlDataAdapter adp1 = new SqlDataAdapter(sql, conn);
                DataSet ds = new DataSet();
                adp1.Fill(ds);
                //载入基本信息
